...
<head>
	<meta charset="UTF-8">
	<title>SPK Pilihan Prodi menggunakan metode AHP</title>
...
<body>
<header>
	<h1>Aplikasi Sistem Pendukung Keputusan Untuk Menentukan Pilihan Prodi di UNSIQ menggunakan metode AHP</h1>
</header>
...
<div class="wrapper">
	<nav id="navigation" role="navigation">
		<ul>
			...
			<li><a class="item" href="data_prodi.php">Daftar Prodi yang ada di UNSIQ</a></li>
			<li>
